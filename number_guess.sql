...
--
-- Name: games add_foreign_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT add_foreign_key FOREIGN KEY (username_id) REFERENCES public.usernames(username_id);
